...
import { User, Phone, Mail, MapPin, Briefcase, Award, Lock, Sparkles, AlertCircle } from 'lucide-react';
...
export default function SignUpForm({ onSuccess }: SignUpFormProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50/60 flex items-center justify-center p-4 sm:p-6 md:p-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-2xl bg-white border border-slate-200 rounded-3xl shadow-xl shadow-slate-100 relative overflow-hidden z-10 animate-in fade-in zoom-in-95 duration-500">
        ...
        <form onSubmit={handleSubmit} className="p-8 sm:p-10 space-y-8">
          ...
          <div className="text-center max-w-md mx-auto">
            ...
            <h2 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight">CA STUDIO</h2>
            <p className="text-sm text-slate-500 mt-2 font-medium">
              Please provide your contact details for us to contact you and activate your workspace.
            </p>
          </div>

          <div className="space-y-6">
            <h3 className="text-xs font-bold text-blue-600 uppercase tracking-widest border-b border-slate-100 pb-2">
                  ...
                  <button
                    ...
                    className={`h-9 px-4 text-xs font-semibold rounded-full border transition-all duration-300 flex items-center gap-2 cursor-pointer
                      ${active 
                        ...
                        : 'bg-slate-50 text-slate-600 border-slate-200 hover:border-slate-350 hover:bg-slate-100/50'}`}
                  >
          ...
          <div className="pt-6 border-t border-slate-100 flex items-center justify-between gap-4">
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 h-12 px-8 text-sm font-bold bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl shadow-[0_4px_14px_0_rgba(37,99,235,0.39)] hover:shadow-[0_6px_20px_rgba(37,99,235,0.23)] hover:scale-[1.01] transition-all cursor-pointer disabled:opacity-60"
            >
              {isSubmitting ? (
                <>
