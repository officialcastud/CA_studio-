...
/* ===== NEW-REGIME variant: opt INTO s.115BAC and strip the Chapter VI-A deductions /
   sub-schedules the new regime disallows, so the return is a VALID new-regime filing that
   exercises the FY2024-25 new slabs and the Rs.7L / Rs.25k s.87A. Only 80CCD(2) (employer NPS)
   and 80CCH (Agnipath) survive, both allowed under the new regime. ===== */
S.fs.optout="No";
S.via={c80ccd2:96000,c80cch:0};
S.pen80ccc=[];S.pen80ccd1=[];S.pen80ccd1b=[];S.c80c=[];
S.g80=[];S.gga=[];S.ggc=[];S.ra=[];
S.d80={selfSr:"N",parSr:"N"};S.u80={};S.dd80={};S.e80={e:[],ee:[],eea:[],eeb:[]};
S.amtc={};
