/* ==========================================================================
   ...
   files u/s 139(1) [code 11] on 25/07/2025, before the 31/07/2025 due date, so
   ...
   HAND COMPUTATION (see tests/ITR-1/figures.json for the full trail):
     ...
     Tax (OLD slab, non-senior): nil to 2,50,000; 5% of 2,50,000 = 12,500;
       ...
       77,480.
     Interest & fee: 234A nil (filed 25/07/2025, before 31/07/2025); 234B nil
...
Object.assign(S.ret, {
  ...
  filed:"25/07/2025",                      /* on or before the 31/07/2025 due date */
...
S.tcs  = [];                                /* no TCS */
S.it = [
  { bsr:"0510308", dt:"15/03/2025", sn:"00742", amt:10000 }   /* advance tax 10,000 */
];
