/* =====================================================================
   YEAR OVERLAY — ITR-1 · A.Y. 2025-26 (F.Y. 2024-25)
   ---------------------------------------------------------------------
   ...
   Sources (AY 2025-26):
     · Assessment year leaf "2025"  and  ItrFilingDueDate "2025-07-31"
       are the values the CBDT AY 2025-26 ITR-1 schema pattern-locks
       (fields_ITR-1_AY2025-26.tsv: Form_ITR1.AssessmentYear pattern 2025,
...
const YC = {
  ...
  ayYear: "2025",           /* Form_ITR1.AssessmentYear / PartA_139_8A.AssessmentYear leaf */
