...
/* 3d CHANGE (AY2025-26): the ESOP allotment-year blocks shift back one year — the
   FULL blocks are 2021-22 … 2024-25, and the current A.Y. (2025-26) is a MINIMAL
   block (AssessmentYear + BalanceTaxCF only). The AY2026-27 ScheduleESOP2627_Type
   and the full 2526 block are dropped. */
const OTH_ESOP_YRS = ["2021-22","2022-23","2023-24","2024-25"];                    /* the four past allotment years (full blocks) */
...
function expOther(j){
  ...
  if(st0(E.pan) || CE.due || CE.soldTotal || st0(E.dpiit)){
    ...
    /* 3d CHANGE (AY2025-26): the current-A.Y. minimal block is ScheduleESOP2526_Type. */
    o.ScheduleESOP2526_Type = {AssessmentYear:YC.currAssYr, BalanceTaxCF:n0(CE.defer2627)};
    j.ScheduleESOP = o;
  }
}
...
function impOther(I3){
  ...
  if(I3 && I3.ScheduleESOP){
    ...
    const yrs = {}, sales = [];
    /* 3d CHANGE (AY2025-26): full blocks 2122-2425; current A.Y. is the minimal 2526 block. */
    [["2021-22","2122"],["2022-23","2223"],["2023-24","2324"],["2024-25","2425"]].forEach(([y,k])=>{
    ...
    S.other.esop = {pan:E.PanofStartUp||"", dpiit:E.DPIITRegNo||"",
      defer2627:nz((E.ScheduleESOP2526_Type||{}).BalanceTaxCF), yrs:yrs, sales:sales};
