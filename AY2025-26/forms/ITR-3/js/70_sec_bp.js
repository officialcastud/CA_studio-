...
function expBp(j){
  ...
  put(j,P+IR+"ProfitLossUs44BBC",sg(B.p44BBC)); /* 3a REMOVE (AY2025-26): ProfitLossUs44BBD dropped (44BBD is AY2026-27-only) */
  ...
  put(j,P+DP+"Section44BBC",n0(B.d35_44BBC)); /* 3a REMOVE (AY2025-26): DeemedProfitBusUs.Section44BBD dropped */
