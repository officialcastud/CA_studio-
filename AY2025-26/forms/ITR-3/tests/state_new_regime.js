/* ====== NEW-REGIME variant of the AY2025-26 golden (S SUDHIR) ======
   Derived from tests/state.js by: S.fs.optout "Yes"->"No" (opt into the new
   regime), and removing the old-regime-only constructs that are disallowed under
   s.115BAC and that trip pre-existing base-engine CYLA/AMTC rules on any naive flip
   (these same rules fire on the untouched AY2026-27 build too): the AMT credit
   (S.tax.amtc) and the self-occupied/let-out house-property loan interest (HP loss
   cannot be set off in the new regime). Used only to prove the FY2024-25 new-regime
   slab tax and new-regime schema conformance. ====== */
/* ====== S SUDHIR · TVOPS4373C · A.Y. 2025-26 — the complete ITR-3 test return (re-dated from the AY2026-27 golden: current-year P.Y./challan/filing/verification dates shifted FY2025-26 -> FY2024-25) ======
...
S.fs={optout:"No",sec:11,incBP:"Y",filed:"28/07/2025",duedate:"2025-10-31",dueExt:"2025-10-31",
  resStatus:"RES",f10ieaDate:"25/07/2025",f10ieaAck:"123456789012345",
  rep:"N",dir:"Y",partner:"Y",unl:"Y",fpi:"N",foreignExch:"Y",
  lei:"3358005G7M7VX2ZUXX88",leiValid:"31/12/2025"};
...
S.aud={sec44AA:"Y",incDclrdUs:"N",salesBand:"Upto10CR",pctRcvd:"Upto5Per",pctPaid:"Upto5Per",sec44AB:"N",sec92E:"N",acct92E:"N",
  oth:[{sec:"80-IA",flag:"Y",date:"10/09/2025",ack:"111122223333444"}],
  act:[]};
...
S.hp={on:"1",pti:0,props:[
 {addr:"No. 42, 3rd Cross, Richmond Town",city:"Bengaluru",country:"91",state:"15",pin:"560025",owner:"SE",co:"NO",type:"S",
  loans:[{from:"B",name:"State Bank of India",acno:"HL3391120044",dt:"12/04/2019",amt:8000000,os:5200000,interest:0}]},
 {addr:"Flat 7B, Prestige Lakeside, Whitefield",city:"Bengaluru",country:"91",state:"15",pin:"560066",owner:"SE",co:"YES",share:50,
  ...
  loans:[{from:"B",name:"HDFC Bank",acno:"HL77812345",dt:"20/07/2021",amt:4500000,os:3900000,interest:0}]}]};
...
S.cg={on:"true",
 land:[
  {buy:"01/06/2024",sale:"01/09/2024",lt:"Short",cons:3000000,sdv:3200000,cost:2500000,exp:50000,improve:[],ded:{},
 ...
 vda:[{buy:"14/07/2024",sale:"09/02/2025",head:"CG",cost:300000,cons:500000}]};
...
S.ded={
 ...
 dd80:{nature:"2",type:"1",amt:125000,dep:"2",pan:"CQKPS1234D",aadhaar:"890123456789",f10dt:"18/06/2025",f10ack:"456789012345678",udid:"KA0412345678901234"},
 u80:{nature:"1",type:"2",amt:75000,dt:"20/06/2025",ack:"654321098765432",udid:"KA0498765432109876"},
...
S.other={
 ...
 esop:{pan:"AAECS9988F",dpiit:"DIPP45678",
   ...
   sales:[{ay:"2022-23",date:"10/06/2024",amt:40000}]}};
...
S.paid={
 ...
 it:[{bsr:"0510308",dt:"14/06/2024",sn:"12",amt:200000},
     {bsr:"0510308",dt:"12/09/2024",sn:"27",amt:300000},
     {bsr:"0510308",dt:"13/12/2024",sn:"41",amt:400000},
     {bsr:"0510308",dt:"14/03/2025",sn:"63",amt:300000},
     {bsr:"0510308",dt:"25/07/2025",sn:"70",amt:200000}]};
...
S.tax={s89:0,f234i:0,
 amtc:{},
 tpsaOn:"Yes",tpsa:{amt:100000,rows:[{bsr:"0510308",bank:"State Bank of India, MG Road",dt:"10/09/2025",chln:"88",amt:15000}]},amtIFSC:0};
...
S.ver={cap:"S",name:"S SUDHIR",father:"S SUBRAMANIAM",pan:"TVOPS4373C",place:"Bengaluru",date:"15/09/2025",nacc:3};
