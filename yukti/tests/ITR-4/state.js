/* ============================================================================
   S SUDHIR · PAN TVOPS4373C · A.Y. 2026-27 — the complete ITR-4 (Sugam) test return
...
S.fs = {
  ...
  f10ieaEarlier:"N",
  f10ieaDateCur:"25/07/2026", f10ieaAckCur:"123456789012345",
  duedate:"2026-08-31", filed:"28/07/2026",
...
S.paid = {
  ...
  it:[ {bsr:"0510308", dt:"14/03/2026", sn:"63", amt:5000},   /* advance tax (≤ 31/03/2026) */
       {bsr:"0510308", dt:"25/07/2026", sn:"70", amt:2000} ]  /* self-assessment tax (≥ 01/04/2026) */
};
