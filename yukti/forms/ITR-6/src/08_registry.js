...
/* screen order from books/ITR-6/structure.md — SECS is sorted by this */
const SCREEN_ORDER=["who","gen","accounts","bp","cg","os","hp","loss","ded","si","ei","mat","fa","al","other","paid","tax","bank"];
